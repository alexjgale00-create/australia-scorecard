// VC.IHR.PSRC.P5 (UNODC intentional homicide data, hosted by the World
...
// living-standards, innovation, etc. See gauges.config.json's dataPolicy
// and METHODOLOGY.md's "Quality of Life dimension" for the verification
// record.
import { runSimpleWorldBankGauge } from "../lib/simpleWorldBankGauge.mjs";

export const gaugeId = "personal-safety";
